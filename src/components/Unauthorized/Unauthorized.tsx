...
//   // 👇 Before this page is shown, ask user
...
//         </p>
//         <p className="text-gray-500 text-sm mb-6">
//           This may be because your user role does not include access to this
//           section, or your session has expired. Please check with your
...
const Unauthorized: React.FC = () => {
  ...
  const { allowNextNavigation } = useConfirmNavigation(
    "Are you sure you want to leave this page? Your data will not be saved.",
    true
  );

  const handleGoHome = () => {
    // 🚀 skip confirmation for this navigation
    allowNextNavigation();
    navigate("/");
  };

  const handleLoginAnother = () => {
    // ❌ confirmation will show here
    navigate("/login");
  };

...
// export default Accommodation;
// =====================================================================================================================================================================================================================================================below is save to editedItinerary===========================================
...
//     // *** MODIFIED LOGIC ***
//     // Load existing accommodation data from sessionStorage when component mounts
//     useEffect(() => {
//         try {
...
//     // *** MODIFIED LOGIC ***
//     // This function saves all booked hotels to the 'editedItinerary' object in sessionStorage.
//     const finalSubmit = () => {
//         if (bookedHotels.length === 0) {
...
//                 ...fullItinerary[0],
//                 "accommodation": bookedHotels // Add/overwrite the accommodation field
//             };
...
//     const handleDelete = () => {
//         // This function clears the form, not the session storage.
//         setSelectedHotel(null);
//         setSearchQuery('');
//         setNumRooms(1);
//         setCheckInDate('');
...
//                                         <input
//                                             type="text" value={countryFilter} onChange={(e) => setCountryFilter(e.target.value)}
//                                             placeholder="e.g., India, USA, Thailand"
//                                             className="w-full p-2 bg-[#F6F6FA] rounded-md text-sm border border-gray-200 focus:ring-2 focus:ring-[#10A4B0] focus:border-transparent"
//                                         />
//                                     </div>
...
//                                                         <p className="text-xs text-gray-500">{hotel.location.city}, {hotel.location.country}</p>
//                                                         <div className="flex items-center mt-1">
//                                                             {Array.from({ length: 5 }).map((_, i) => <StarIcon key={i} filled={i < hotel.rating} />)}
//                                                         </div>
//                                                     </div>
//                                                 </div>
//                                             ))}
...
//                                             <label className="text-xs font-medium text-gray-700 block mb-2">Number of Rooms</label>
//                                             <div className="flex items-center gap-2">
//                                                 <button onClick={removeRoom} disabled={numRooms <= 1} className="p-2 border border-gray-300 rounded hover:bg-gray-100 disabled:opacity-50"><MinusIcon /></button>
...
//                                                 <button onClick={addRoom} className="p-2 border border-gray-300 rounded hover:bg-gray-100"><PlusIcon /></button>
//                                             </div>
//                                         </div>
//                                         <div>
//                                             <label className="text-xs font-medium text-gray-700 block mb-2">Check In</label>
...
//                                     <button onClick={handleDelete} className="px-6 py-2 bg-gray-100 text-gray-700 border border-gray-300 rounded-md font-semibold text-sm hover:bg-gray-200">Clear All</button>
//                                     <button onClick={addToBookings} disabled={!selectedHotel} className="px-6 py-2 bg-teal-500 text-white rounded-md font-semibold text-sm hover:bg-teal-600 disabled:bg-gray-400">Add to Booking</button>
//                                     <button onClick={finalSubmit} disabled={bookedHotels.length === 0} className="px-6 py-2 bg-[#10A4B0] text-white rounded-md font-semibold text-sm hover:bg-teal-600 disabled:bg-gray-400">Save All Bookings ({bookedHotels.length})</button>
//                                 </div>
//                             </div>
//                         </div>
//                     </div>

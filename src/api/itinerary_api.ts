...
// ✅ **FIXED**: The ItinerarySavePayload now expects a complex object (`Record<string, any>`)
// which correctly matches the data structure you are sending.
interface ItinerarySavePayload {
  ...
  // This can be further detailed, but Record<string, any> accepts any object structure.
  [key: string]: any; // Allows for all other properties like banner, days, etc.
}
